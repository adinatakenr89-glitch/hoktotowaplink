...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>HOKTOTO | Login Terbaru: Petualangan Seru di Dunia Monster Pilihan</title>
        <meta name="description" content="Akses HOKTOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
        ...
        <meta name="twitter:title" content="HOKTOTO | Login Terbaru: Petualangan Seru di Dunia Monster Pilihan" />
        <meta name="twitter:description" content="Akses HOKTOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
      ...
      <style jsx global>{`
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Nunito Sans',sans-serif;background:#001820;color:#e0e0e0;line-height:1.7;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .W{max-width:1200px;margin:0 auto;padding:0 24px}

        .topbar{background:#002530;border-bottom:1px solid rgba(0,180,216,.25);padding:7px 0;font-size:12px;color:#ccc}
        .topbar-inner{display:flex;justify-content:space-between;align-items:center}
        .topbar a{color:#00b4d8;font-weight:700;transition:.2s}.topbar a:hover{opacity:.8}

        header{background:#002530;border-bottom:1px solid rgba(0,180,216,.25);position:sticky;top:0;z-index:50;backdrop-filter:blur(12px)}
        .hd{display:flex;align-items:center;justify-content:space-between;padding:12px 0;gap:14px}
        .logo{display:flex;align-items:center;gap:10px;font-weight:900;font-size:24px;color:#00b4d8;flex-shrink:0}
        .logo img{width:38px;height:38px;border-radius:12px;border:2px solid #00b4d8}
        ...
        .nav-mid a:hover,.nav-mid a.act{color:#fff;background:#00b4d8}
        ...
        .btn-p{background:#00b4d8;color:#fff}.btn-p:hover{background:#0096b4;transform:translateY(-1px)}
        .btn-o{border:2px solid #00b4d8;color:#00b4d8;background:transparent}.btn-o:hover{background:rgba(0,180,216,.14)}

        .hero{background:#002530;padding:50px 0;position:relative;overflow:hidden}
        .hero::before{content:'';position:absolute;right:-150px;top:-80px;width:500px;height:500px;border-radius:50%;background:rgba(0,180,216,.14)}
        .hero::after{content:'';position:absolute;left:-100px;bottom:-120px;width:400px;height:400px;border-radius:50%;background:rgba(0,180,216,.14)}
        .hero-flex{display:flex;align-items:center;gap:44px;position:relative;z-index:1}
        .hero-text{flex:1}
        .hero-text .chip{display:inline-flex;align-items:center;gap:8px;background:#00b4d8;color:#fff;padding:7px 18px;border-radius:14px;font-size:12px;font-weight:800;margin-bottom:18px;text-transform:uppercase;letter-spacing:.5px}
        ...
        .hero-text .btn-hero.fill{background:#00b4d8;color:#fff}
        .hero-text .btn-hero.fill:hover{background:#0096b4;transform:translateY(-2px);box-shadow:0 10px 28px rgba(0,0,0,.3)}
        .hero-text .btn-hero.line{background:transparent;color:#00b4d8;border:2px solid #00b4d8}
        .hero-text .btn-hero.line:hover{background:rgba(0,180,216,.14)}
        ...
        .hero-img img{border-radius:20px;box-shadow:0 24px 64px rgba(0,0,0,.45);border:2px solid rgba(0,180,216,.25)}

        .stats{background:#003240;border-top:1px solid rgba(0,180,216,.25);border-bottom:1px solid rgba(0,180,216,.25);padding:26px 0}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;text-align:center}
        .stat-item{padding:8px 0}
        .stat-item .sv{font-size:28px;font-weight:900;color:#00b4d8}
        .stat-item .sl{font-size:10px;color:#bbb;text-transform:uppercase;letter-spacing:1.5px;margin-top:3px;font-weight:600}

        .sec{padding:56px 0}
        .sec-alt{background:#002530}
        .sec-head{text-align:center;margin-bottom:40px}
        .sec-head .badge{display:inline-block;background:#00b4d8;color:#fff;padding:6px 20px;border-radius:14px;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;margin-bottom:14px}
        ...
        .art-content h3{font-size:22px;font-weight:800;margin-bottom:18px;color:#00b4d8}
        ...
        .art-gallery img{border-radius:16px;border:2px solid rgba(0,180,216,.25);width:100%;height:210px;object-fit:cover;transition:.3s}
        .art-gallery img:hover{border-color:#00b4d8;transform:scale(1.02)}
        .art-tags{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}
        .art-tag{background:#00b4d8;color:#fff;padding:6px 16px;border-radius:14px;font-size:11px;font-weight:700}

        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}
        .feat-card{background:#003240;border:2px solid rgba(0,180,216,.25);border-radius:20px;padding:28px;transition:.3s}
        .feat-card:hover{border-color:#00b4d8;transform:translateY(-5px);box-shadow:0 12px 36px rgba(0,0,0,.25)}
        .feat-card .fi-icon{width:52px;height:52px;border-radius:16px;background:rgba(0,180,216,.14);display:flex;align-items:center;justify-content:center;font-size:24px;margin-bottom:16px}
        ...
        .cta-box{background:linear-gradient(135deg,#0096b4,#00b4d8);border-radius:24px;padding:56px 36px;text-align:center;color:#fff;position:relative;overflow:hidden}
        ...
        .cta-box .btn-cta{background:#fff;color:#001820;font-weight:800;padding:16px 38px;border-radius:16px;border:none;cursor:pointer;font-family:inherit;font-size:16px;transition:.25s}
        ...
        .bnr-card{border-radius:16px;overflow:hidden;border:2px solid rgba(0,180,216,.25);transition:.3s}
        .bnr-card:hover{transform:translateY(-4px);box-shadow:0 10px 30px rgba(0,0,0,.25);border-color:#00b4d8}
        .bnr-card img{width:100%;height:auto}

        .faq-list{max-width:740px;margin:0 auto}
        .faq-item{background:#003240;border:2px solid rgba(0,180,216,.25);border-radius:16px;padding:20px 24px;margin-bottom:10px;cursor:pointer;transition:.25s}
        ...
        .faq-q span{color:#00b4d8;font-size:20px;font-weight:800}
        .faq-a{margin-top:12px;color:#bbb;font-size:14px;line-height:1.75;border-top:1px solid rgba(0,180,216,.25);padding-top:12px;text-align:justify}

        footer{background:#002530;border-top:2px solid rgba(0,180,216,.25);padding:40px 0;font-size:13px}
        .ft-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:30px;margin-bottom:24px}
        .ft-col h4{color:#00b4d8;font-size:15px;font-weight:800;margin-bottom:14px}
        .ft-col a{display:block;color:#aaa;margin-bottom:8px;transition:.2s;font-weight:500}.ft-col a:hover{color:#00b4d8}
        .ft-bottom{border-top:1px solid rgba(0,180,216,.25);padding-top:20px;text-align:center;color:#999}
        ...
        <section className="hero"><div className="W">
          <div className="hero-flex">
            <div className="hero-text">
              ...
              <h1>HOKTOTO | Login Terbaru: Petualangan Seru di Dunia Monster Pilihan</h1>
              <p>Akses HOKTOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna.</p>
              <div className="hbtns">
        ...
        <section className="sec sec-alt" id="tentang"><div className="W">
          ...
          <div className="art-row">
            <div className="art-content">
              ...
              <p>HOKTOTO melalui situs resmi HOKTOTO hadir sebagai platform digital terpercaya yang menyediakan akses login dan daftar dengan teknologi keamanan terkini. Layaknya sebuah bengkel profesional yang selalu siap melayani pelanggan, HOKTOTO memastikan setiap pengguna mendapatkan layanan yang handal dan responsif. Infrastruktur server kami dirancang dengan standar industri tertinggi, menghadirkan performa optimal dengan uptime 99,9% yang menjamin ketersediaan akses tanpa gangguan.</p>
              <div className="art-gallery">
              ...
              <p>Keunggulan HOKTOTO di situs resmi HOKTOTO terletak pada sistem keamanan berlapis SSL 256-bit yang melindungi setiap data dan transaksi pengguna. Seperti mesin yang terawat dengan baik di bengkel terpercaya, sistem kami bekerja secara presisi dan efisien. Tim support profesional tersedia 24 jam nonstop untuk membantu setiap kebutuhan teknis, memastikan pengalaman digital Anda berjalan lancar tanpa hambatan. Link alternatif resmi selalu diperbarui untuk menjamin aksesibilitas dari berbagai jaringan di Indonesia.</p>
